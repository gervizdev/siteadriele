      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services?.map((service) => {
            ...
            const iconColor = serviceColors[service.name as keyof typeof serviceColors] || "bg-rose-primary";
            ...
            return (
              ...
              >
                <div className={`${iconColor} p-4 rounded-full w-16 h-16 flex items-center justify-center mb-6`}>
